  ...
  return (
    <section className="glass-card p-4 sm:p-8 rounded-card shadow-lg">
      <h2 className="text-base sm:text-lg font-bold text-textPrimary flex items-center gap-2 mb-6 border-b border-white/5 pb-4 bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent">
        <LockKeyhole size={18} className="text-primary shrink-0" /> Policy-Safe Follow-ups
      </h2>

      <div className="space-y-6">
        <div className="flex items-center justify-between p-4 sm:p-5 bg-white/[0.01] border border-white/5 rounded-2xl backdrop-blur-sm gap-3">
          <div>
            <p className="font-semibold text-xs sm:text-sm text-textPrimary block mb-1">
          ...
          <label className="relative inline-flex items-center cursor-pointer select-none shrink-0 min-h-[44px]">
            <input
              type="checkbox"
