      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-white/[0.02] border border-white/5 rounded-xl px-4 py-3 text-textPrimary focus:border-primary/40 focus:ring-1 focus:ring-primary/40 focus:outline-none disabled:opacity-60 transition-all select-none"
          >
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            className="w-full bg-white/[0.02] border border-white/5 rounded-xl px-4 py-3 text-textPrimary focus:border-primary/40 focus:ring-1 focus:ring-primary/40 focus:outline-none font-mono disabled:opacity-60 transition-all"
          />
        </div>
      </div>
    </section>
